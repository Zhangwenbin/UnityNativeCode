...
public class XHook {
    ...
    public synchronized void refresh(boolean async) {
        ...
        try {
            com.qiyi.xhook.XHookNativeHandler.getInstance().refresh(async);
        } catch (Throwable ex) {
            ex.printStackTrace();
    ...
    public synchronized void clear() {
        ...
        try {
            com.qiyi.xhook.XHookNativeHandler.getInstance().clear();
        } catch (Throwable ex) {
            ex.printStackTrace();
    ...
    public synchronized void enableDebug(boolean flag) {
        ...
        try {
            com.qiyi.xhook.XHookNativeHandler.getInstance().enableDebug(flag);
        } catch (Throwable ex) {
            ex.printStackTrace();
    ...
    public synchronized void enableSigSegvProtection(boolean flag) {
        ...
        try {
            com.qiyi.xhook.XHookNativeHandler.getInstance().enableSigSegvProtection(flag);
        } catch (Throwable ex) {
            ex.printStackTrace();
